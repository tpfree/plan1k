...
<h2 class="contentTitle">教育经历信息</h2>
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" target="navTab"
				href="<c:url value='eduInfoController.do?add&flag=0'/>" width="600"
				height="450"><span>添加经历</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" target="navTab"
				href="<c:url value='eduInfoController.do?edit&eduId={slt_eduId}&flag=0'/>"
				title="修改数据"><span>修改经历</span></a></li>
			<li class="line">line</li>
			<li><a class="delete" target="ajaxToDo"
				href="<c:url value='eduInfoController.do?delete&eduId={slt_eduId}&callbackType=forward&flag=0'/>"
...
<div class="formBar">
	...
	<li><div class="button">
				<div class="buttonContent"
					...
					<a href="<c:url value='baseInfoController.do?getInfo'/>"
						style="text-decoration:none;" target="navTab" title="个人基础资料"
						rel="pyrcsb">上&nbsp;&nbsp;一&nbsp;&nbsp;步</a>
				</div>
			</div></li>
		<li><div class="button">
